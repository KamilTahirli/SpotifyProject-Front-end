    ...
    <header class="header">
      <div class="header__content">
        ...
        <div class="header__actions">
          ...
          <div v-if="$auth.loggedIn && this.$auth.user.role_id === 1" class="header__action header__action--note">
            <router-link to="/panel" class="header__action-btn">
          ...
          <span v-if="!$auth.loggedIn">
              <router-link to="/auth/login" class="header__action-btn">
              <span>Daxil ol</span>
            </router-link>
          </span>
            <span v-else class="header__action-btn">
                  <router-link to="/profile">
              <span>{{ this.$auth.user.full_name }}</span>
            </router-link>
             <i @click.prevent="logout" class="fa-solid fa-arrow-right-from-bracket"></i>
            </span>
          </div>
        </div>
...
<script>
import Sidebar from "@/components/layouts/front/sidebar.vue";
...
export default {
  name: 'HeaderPage',
  components: {Sidebar, SearchBox, Player},
